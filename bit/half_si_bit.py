    ...
    for id_ch in range(0, inchs):
        for id_row in range(0, rows ):
            for id_col in range(0, cols ):
                empty_data[id_ch][id_row][id_col] = random.randint(-128, 127)
    return empty_data
...
def create_data_m(inchs, rows, cols):
    ...
    for id_ch in range(0, inchs):
        for id_row in range(0, rows ):
            for id_col in range(0, cols ):
                empty_data[id_ch][id_row][id_col] = random.randint(-128, 0)
    return empty_data
...
def create_data_p(inchs, rows, cols):
    ...
    for id_ch in range(0, inchs):
        for id_row in range(0, rows ):
            for id_col in range(0, cols ):
                empty_data[id_ch][id_row][id_col] = random.randint(0, 127)
    return empty_data
...
def create_data_max(inchs, rows, cols):
    ...
    for id_ch in range(0, inchs):
        for id_row in range(0, rows ):
            for id_col in range(0, cols ):
                empty_data[id_ch][id_row][id_col] = 127
    return empty_data
...
def create_data_min(inchs, rows, cols):
    ...
    for id_ch in range(0, inchs):
        for id_row in range(0, rows ):
            for id_col in range(0, cols ):
                empty_data[id_ch][id_row][id_col] = -128
    return empty_data
    ...
    for id_ch in range(0, len(in_data)):
        for id_row in range(0, len(in_data[id_ch])):
            for id_col in range(0, len(in_data[id_ch][id_row])):
                ...
                f.write('8\'h')
                if in_data[id_ch][id_row][id_col] < 0:
                    f.write(format(val & 0xff, '02x'))
                else:
...
"""
# random sum_1>0, sum_2 <0
in_d_0 = create_data_p(8, 5, 5)
in_d_1 = create_data_p(8, 5, 5)
in_w_0 = create_data_p(8, 5, 5)
in_w_1 = create_data_p(8, 5, 5)
in_w_2 = create_data_m(8, 5, 5)
in_w_3 = create_data_m(8, 5, 5)
"""
